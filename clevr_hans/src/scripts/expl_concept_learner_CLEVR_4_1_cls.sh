...
--name "retbind_settransformer-1obj-$NUM" --batch-size 512 --seed $SEED --mode expls --expl_thresh 0.25 \
...
--precompute-bind \
--fp-ckpt "/workspace/repositories/SysBindRetrieve/clevr_hans/src/runs/CLEVR_4_1_cls/retbind_settransformer-1obj-$NUM-CLEVR_4_1_cls_seed$SEED/*_bestvalloss_*.pth"