...
--name "conf_xil_delete_retbind_settransformer-1obj-$NUM" --lr 0.001 --batch-size 512 --seed $SEED --mode xil_delete \
...
--precompute-bind \
--feedback_path "clevr_hans/src/runs/CLEVR_4_1_cls/conf_retbind_settransformer-1obj-0-CLEVR_4_1_cls_seed$SEED/neg_feedback_dict.pkl"
