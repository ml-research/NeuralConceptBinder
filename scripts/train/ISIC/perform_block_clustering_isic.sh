...
--temp 1. --thresh_count_obj_slots -1 --num_samples_clustering 2000 \
--data_path '/workspace/datasets/ISIC19/' \
--checkpoint_path /workspace/repositories/NeuralConceptBinder/logs/isic/isic_seed0_unnorm/best_model.pt \
--no_norm_isic