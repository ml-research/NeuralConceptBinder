...
--checkpoint_path 'logs/clevr4_600_epochs/clevr4_sysbind_hard_seed0/best_model.pt'
...
--d_model 192 --dropout 0.1 --tau_start 0.1 --tau_final 0.1 --tau_steps 1 --use_dp --temp 1e-4 \
--data_path '/workspace/datasets-local/CLEVR-4-1/train/images/*.png' \
--checkpoint_path 'logs/clevr4_600_epochs/clevr4_sysbind_hard_seed1/best_model.pt'
...
--d_model 192 --dropout 0.1 --tau_start 0.1 --tau_final 0.1 --tau_steps 1 --use_dp --temp 1e-4 \
--data_path '/workspace/datasets-local/CLEVR-4-1/train/images/*.png' \
--checkpoint_path 'logs/clevr4_600_epochs/clevr4_sysbind_hard_seed2/best_model.pt'
