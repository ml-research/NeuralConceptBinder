...
--data_path '/workspace/datasets_wolf/CLEVR-4-1/train/images/*.png' \
--checkpoint_path 'logs/clevr4_600_epochs/clevr4_sysbind_orig_seed0/best_model.pt'
...
#--checkpoint_path 'logs/clevr4_600_epochs/clevr4_sysbind_orig_seed1/best_model.pt'
#
#CUDA_VISIBLE_DEVICES=$DEVICE python sysbinder/train.py \
...
#--d_model 192 --dropout 0.1 --tau_start 0.1 --tau_final 0.1 --tau_steps 1 --use_dp --temp 1. \
#--data_path '/workspace/datasets-local/CLEVR-4-1/train/images/*.png' \
#--checkpoint_path 'logs/clevr4_600_epochs/clevr4_sysbind_orig_seed2/best_model.pt'
