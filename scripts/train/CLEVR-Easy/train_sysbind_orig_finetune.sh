...
--checkpoint_path 'logs/clevr_easy_500_epochs/sysbind_orig_seed0/best_model.pt'
...
--d_model 192 --dropout 0.1 --tau_start 0.1 --tau_final 0.1 --tau_steps 1 --use_dp --temp 1. \
--data_path '/workspace/datasets-local/CLEVR-Easy-1/train/images/*.png' \
--checkpoint_path 'logs/clevr_easy_500_epochs/sysbind_orig_seed1/best_model.pt'
...
--d_model 192 --dropout 0.1 --tau_start 0.1 --tau_final 0.1 --tau_steps 1 --use_dp --temp 1. \
--data_path '/workspace/datasets-local/CLEVR-Easy-1/train/images/*.png' \
--checkpoint_path 'logs/clevr_easy_500_epochs/sysbind_orig_seed2/best_model.pt'
