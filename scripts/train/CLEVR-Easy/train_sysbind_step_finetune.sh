...
--checkpoint_path 'logs/clevr_easy_500_epochs/sysbind_step_seed0/last_model.pt'
...
--d_model 192 --dropout 0.1 --tau_start 0.1 --tau_final 0.1 --tau_steps 1 --use_dp --temp 1. --temp_step \
--data_path '/workspace/datasets-local/CLEVR-Easy-1/train/images/*.png' \
--checkpoint_path 'logs/clevr_easy_500_epochs/sysbind_step_seed1/last_model.pt'
...
--d_model 192 --dropout 0.1 --tau_start 0.1 --tau_final 0.1 --tau_steps 1 --use_dp --temp 1. --temp_step \
--data_path '/workspace/datasets-local/CLEVR-Easy-1/train/images/*.png' \
--checkpoint_path 'logs/clevr_easy_500_epochs/sysbind_step_seed2/last_model.pt'
