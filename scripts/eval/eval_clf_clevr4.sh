...
# the best model from those runs and finetuned for 2 epochs on the training set of CLEVR-4-1 and are now taking the
...
--checkpoint_path logs/clevr4_600_epochs/clevr4_sysbind_orig_seed${SEED}_finetune/last_model.pt --seed 0 \
...
--checkpoint_path logs/clevr4_600_epochs/clevr4_sysbind_hard_seed${SEED}_finetune/last_model.pt --seed 0 \
...
--checkpoint_path logs/clevr4_600_epochs/clevr4_sysbind_step_seed${SEED}_finetune/last_model.pt --seed 0 \
--thresh_count_obj_slot 0 --num_categories $NCATS --perc_imgs $PIMGS --binarize
